...
-- Add primary_gym_id to trainer_profiles for main gym display (referencing gym_id directly)
ALTER TABLE public.trainer_profiles 
ADD COLUMN primary_gym_id UUID;
...
-- Allow public viewing of approved affiliations for trainer profiles
CREATE POLICY "Public can view approved affiliations" 
ON public.trainer_gym_affiliations 
FOR SELECT 
