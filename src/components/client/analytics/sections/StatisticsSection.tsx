...
export function StatisticsSection() {
  return (
    <div className="space-y-3 w-full">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-1.5 w-full">
        <StatCard 
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-1.5 mt-3 w-full">
        <MetricCard 
          title="Weekly Stats" 
          metrics={[
