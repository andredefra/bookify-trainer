...
const initialTransactions: TransactionType[] = [
  ...
  { id: 2, client: "Sarah Johnson", type: "Package", name: "Personal Training Package (10 sessions)", amount: 250, date: "2023-07-15", status: "pending", paymentMethod: "card", invoiceSent: false, isPackagePayment: true, packageId: "pkg-001", isInstallment: true, installmentNumber: 2, totalInstallments: 2, installmentStatus: "pending", parentTransactionId: "parent-1", dueDate: "2023-07-15" },
  ...
  { id: 6, client: "Lisa Garcia", type: "Package", name: "Complete Transformation Package", amount: 250, date: "2023-08-10", status: "pending", paymentMethod: "card", invoiceSent: false, isPackagePayment: true, isInstallment: true, installmentNumber: 3, totalInstallments: 3, installmentStatus: "pending", parentTransactionId: "parent-2", dueDate: "2023-08-10" },
