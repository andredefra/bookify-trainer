      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          <div className="bg-muted/50 rounded-lg p-3 space-y-1 text-sm">
            ...
            <p><span className="text-muted-foreground">Package:</span> {sale.packageTitle}</p>
...
export function SalesHistoryTable({ 
  ...
  const [cashDialogSale, setCashDialogSale] = useState<ProgramSale | null>(null);
  const [invoiceUploadSale, setInvoiceUploadSale] = useState<ProgramSale | null>(null);
  const [invoiceDetailsSale, setInvoiceDetailsSale] = useState<ProgramSale | null>(null);
  ...
  const renderActions = (sale: ProgramSale) => {
    ...
    // Rejected or no-show - just show status
    return null;
  };
