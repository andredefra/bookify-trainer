      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center space-y-8 md:space-y-10">
          ...
          <div className="reveal reveal-delay-2 flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
            <Link to="/register" className="w-full sm:w-auto px-8 py-3 md:py-4 bg-primary text-white rounded-full text-base md:text-lg font-medium button-hover">
              Try the Demo
            </Link>
            <Link to="/find-trainer" className="w-full sm:w-auto px-8 py-3 md:py-4 bg-white text-primary rounded-full text-base md:text-lg font-medium border border-primary/10 button-hover">
        ...
        {/* Dashboard preview */}
        <div ref={elementRef} className="reveal reveal-delay-3 mt-16 md:mt-24 mb-10 md:mb-16 max-w-5xl mx-auto rounded-2xl shadow-2xl glass overflow-hidden">
