...
export const programSalesData: ProgramSalesDataPoint[] = [
  { programName: 'Strength & Conditioning', source: 'direct', sourceName: 'Diretto', unitsSold: 15, revenue: 2250, commissions: 0, netRevenue: 2250 },
  ...
  { programName: 'Weight Loss Program', source: 'direct', sourceName: 'Diretto', unitsSold: 12, revenue: 1800, commissions: 0, netRevenue: 1800 },
  { programName: 'Weight Loss Program', source: 'gym', sourceName: 'PowerHouse', unitsSold: 5, revenue: 750, commissions: 75, netRevenue: 675 },
  { programName: 'HIIT Extreme', source: 'direct', sourceName: 'Diretto', unitsSold: 10, revenue: 1500, commissions: 0, netRevenue: 1500 },
  { programName: 'HIIT Extreme', source: 'gym', sourceName: 'FitLife Gym', unitsSold: 6, revenue: 900, commissions: 90, netRevenue: 810 },
  { programName: 'Flexibility & Mobility', source: 'direct', sourceName: 'Diretto', unitsSold: 8, revenue: 960, commissions: 0, netRevenue: 960 },
  ...
  { programName: 'Beginner Fitness', source: 'direct', sourceName: 'Diretto', unitsSold: 18, revenue: 1440, commissions: 0, netRevenue: 1440 },
...
export const monthlySourceRevenueData: MonthlySourceRevenueDataPoint[] = [
  { month: 'Gen', direct: 3200, gym: 1800, studio: 400, total: 5400 },
  ...
  { month: 'Mag', direct: 4400, gym: 2900, studio: 600, total: 7900 },
  { month: 'Giu', direct: 4800, gym: 3100, studio: 650, total: 8550 },
  { month: 'Lug', direct: 5200, gym: 3400, studio: 700, total: 9300 },
  { month: 'Ago', direct: 4600, gym: 2800, studio: 550, total: 7950 },
  { month: 'Set', direct: 5100, gym: 3200, studio: 680, total: 8980 },
  { month: 'Ott', direct: 5500, gym: 3500, studio: 720, total: 9720 },
  { month: 'Nov', direct: 5800, gym: 3800, studio: 780, total: 10380 },
  { month: 'Dic', direct: 6200, gym: 4100, studio: 850, total: 11150 },
];
...
export const kpiData: KPIWithBreakdown[] = [
  { 
    ...
    isPositive: true,
    breakdown: [
      { source: 'Diretto', value: '€21.600', percentage: 56 },
      { source: 'Gym Partner', value: '€13.800', percentage: 36 },
      { source: 'Studio Network', value: '€3.000', percentage: 8 }
    ]
  },
  { 
    label: "Programmi Venduti", 
    value: "93",
    change: "+25%",
    isPositive: true,
    breakdown: [
      { source: 'Diretto', value: '63', percentage: 68 },
  ...
  { 
    ...
    isPositive: true,
    breakdown: [
      { source: 'Diretto', value: '186', percentage: 60 },
  ...
  { 
    ...
    isPositive: true,
    breakdown: [
      { source: 'Diretto', value: '28', percentage: 60 },
...
export const revenueByProductType = [
  { name: 'Programmi', value: 15000, percentage: 39 },
  { name: 'Sessioni', value: 11700, percentage: 30 },
  { name: 'Pacchetti', value: 7900, percentage: 21 },
  { name: 'Servizi', value: 3800, percentage: 10 },
];
