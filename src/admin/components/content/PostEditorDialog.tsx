...
import type { MktContent, MktPlanMonth } from "../../types";
    ...
    update.mutate(
      {
        ...
        patch: {
          ...
          notes: draft.notes,
          // Metrics editable always (even if readOnly above we already blocked)
          views: draft.views,
          ...
          <div className="space-y-3">
            ...
            {draft.scheduled_date && (
              <div className="rounded-md bg-muted/40 p-2 text-xs">
                <strong>Calendarizzato:</strong> {draft.scheduled_date} {draft.scheduled_time?.slice(0, 5) ?? ""}
                <p className="text-muted-foreground mt-0.5">
                  Data e ora sono scelte dall'AI dal "Calendarizza con AI". Modifica manuale dal Calendario.
                </p>
              </div>
            )}
          ...
          <div className="space-y-4">
            ...
            {readOnly && (
              <div className="border rounded-md p-3 space-y-2">
                <p className="text-xs font-medium">Metriche (editabili dopo la pubblicazione)</p>
                <div className="grid grid-cols-2 gap-2">
                  <div>
