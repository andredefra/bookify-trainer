export const en = {
  ...
  'pricing.features.upTo10Clients': 'Up to 10 Clients',
  'pricing.features.basicCalendar': 'Basic Calendar Management',
  'pricing.features.limitedMessaging': 'Messaging (50 msg/month per client)',
  'pricing.features.sessionPostponement': 'Session Postponement System',
  'pricing.features.personalTrainerPage': 'Personal Trainer Page',
  'pricing.features.clientManagement': 'Basic Client Management',
  'pricing.features.unlimitedClients': 'Unlimited Clients & Sessions',
  'pricing.features.googleCalendar': 'Google Calendar Integration',
  'pricing.features.unlimitedMessaging': 'Unlimited Messaging',
  'pricing.features.customPrograms': 'Custom Training Programs',
  'pricing.features.waitlistManagement': 'Waitlist Management',
  'pricing.features.advancedPrograms': 'Advanced Program Management',
  ...
  'pricing.features.advancedCRM': 'Advanced Sales CRM',
  ...
  'pricing.detailedFeatures.basic.clientManagement.name': 'Client Management (up to 10)',
  'pricing.detailedFeatures.basic.clientManagement.description': 'Complete client database with comprehensive profiles (goals, medical limitations, preferences), session history and progress tracking for each client, private notes and annotations system, contact and emergency information management.',
  'pricing.detailedFeatures.basic.messaging.name': 'Client Messaging System',
  'pricing.detailedFeatures.basic.messaging.description': 'Real-time trainer-client chat, photo/video sharing for form checking, automatic session reminder messages, push notification system. Limit: 50 messages/month per client.',
  'pricing.detailedFeatures.basic.calendar.name': 'Calendar Integration',
  'pricing.detailedFeatures.basic.calendar.description': 'Integrated calendar with event management, session postponement system with automatic notifications, availability management, basic scheduling features.',
  ...
  'pricing.detailedFeatures.essential.unlimitedSessions.name': 'Unlimited Sessions & Clients',
  'pricing.detailedFeatures.essential.unlimitedSessions.description': 'Create individual and group sessions, dynamic calendar with real-time availability, direct client booking system, flexible cancellation system, no monthly session limits.',
  ...
  'pricing.detailedFeatures.essential.unlimitedMessaging.name': 'Unlimited Messaging',
  'pricing.detailedFeatures.essential.unlimitedMessaging.description': 'No limits on client communication, multimedia sharing, automated workflows, priority notifications.',
  ...
  'pricing.detailedFeatures.pro.salesCrm.name': 'Advanced Sales CRM',
  'pricing.detailedFeatures.pro.salesCrm.description': 'Kanban-style sales pipeline, lead scoring and qualification, automated sales sequences, conversion analytics, sales performance tracking.',
