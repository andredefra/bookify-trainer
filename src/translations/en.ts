...
export const en = {
  ...
  'pricing.standard.fee': 'No transaction fees',
  'pricing.standard.cta': 'Start with Standard',
  'pricing.freemium.title': 'Basic',
  'pricing.freemium.price': '€9',
  'pricing.freemium.period': '/month',
  'pricing.freemium.fee': 'No transaction fees',
  ...
  'pricing.business.title': 'Business Solutions',
  'pricing.business.subtitle': 'Specialized plans for gyms and fitness facilities',
  'pricing.gymTrainer.title': 'Gym Trainer',
  'pricing.gymTrainer.price': '€9',
  'pricing.gymTrainer.priceAnnual': '€7',
  'pricing.gymTrainer.period': '/month',
  'pricing.gymTrainer.fee': '+ 2% transaction fee',
  'pricing.gymTrainer.cta': 'Join as Gym Trainer',
  'pricing.gymTrainer.note': 'Only available for trainers affiliated with partner gyms',
  'pricing.gym.title': 'Gym',
  'pricing.gym.price': '€59',
  'pricing.gym.priceAnnual': '€49',
  'pricing.gym.period': '/month',
  'pricing.gym.fee': 'No platform fee for your trainers',
  'pricing.gym.cta': 'Contact Sales',
  ...
  'pricing.features.everythingFreemium': 'Everything in Basic',
  'pricing.features.everythingPro': 'Everything in Pro Plan',
  'pricing.features.lowerFee': 'Lower Transaction Fee (1.5%)',
  ...
  'pricing.features.gymBranding': 'Gym Branding',
  'pricing.features.gymClientAccess': 'Access to Gym Client Base',
  'pricing.features.directMessaging': 'Direct Client Messaging',
  ...
  'pricing.features.brandedTrainerPages': 'Branded Trainer Pages',
  'pricing.features.directClientCommunication': 'Direct Client Communication',
  'pricing.features.analyticsAccess': 'Access to Analytics Dashboard',
