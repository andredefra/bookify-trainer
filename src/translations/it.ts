export const it = {
  ...
  'pricing.forGyms': 'Per Studi di Personal Trainer e Piccole Palestre',
  'pricing.gymPlanDescription': 'Soluzione completa per studi di personal trainer e piccole palestre con più trainer',
