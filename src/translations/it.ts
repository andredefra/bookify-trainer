...
export const it = {
  ...
  'pricing.business.title': 'Soluzioni Business',
  'pricing.business.subtitle': 'Piani specializzati per palestre e centri fitness',
  'pricing.gymTrainer.title': 'Trainer Palestra',
  'pricing.gymTrainer.price': '€9',
  'pricing.gymTrainer.priceAnnual': '€7',
  'pricing.gymTrainer.period': '/mese',
  'pricing.gymTrainer.fee': '+ 2% commissione sulle transazioni',
  'pricing.gymTrainer.cta': 'Unisciti come Trainer Palestra',
  'pricing.gymTrainer.note': 'Disponibile solo per trainer affiliati con palestre partner',
  'pricing.gym.title': 'Palestra',
  'pricing.gym.price': '€59',
  'pricing.gym.priceAnnual': '€49',
  'pricing.gym.period': '/mese',
  'pricing.gym.fee': 'Nessuna commissione piattaforma per i tuoi trainer',
  'pricing.gym.cta': 'Contatta Vendite',
  ...
  'pricing.features.everythingPro': 'Tutto del Piano Pro',
  ...
  'pricing.features.gymBranding': 'Branding Palestra',
  'pricing.features.gymClientAccess': 'Accesso alla Base Clienti della Palestra',
  'pricing.features.directMessaging': 'Messaggistica Diretta con i Clienti',
  'pricing.features.whiteLabel': 'Piattaforma White Label',
  'pricing.features.unlimitedTrainers': 'Trainer Illimitati',
  'pricing.features.unlimitedClients': 'Clienti Illimitati',
  'pricing.features.brandedTrainerPages': 'Pagine Trainer Personalizzate',
  'pricing.features.directClientCommunication': 'Comunicazione Diretta con i Clienti',
  'pricing.features.analyticsAccess': 'Accesso alla Dashboard Analitica',
  'pricing.features.crmIntegration': 'Integrazione CRM',
