export const it = {
  ...
  'pricing.features.upTo10Clients': 'Fino a 10 Clienti',
  'pricing.features.basicCalendar': 'Gestione Calendario Base',
  'pricing.features.limitedMessaging': 'Messaggistica (50 msg/mese per cliente)',
  'pricing.features.sessionPostponement': 'Sistema Rinvio Sessioni',
  'pricing.features.personalTrainerPage': 'Pagina Personal Trainer',
  'pricing.features.clientManagement': 'Gestione Clienti Base',
  'pricing.features.unlimitedClients': 'Clienti e Sessioni Illimitati',
  'pricing.features.googleCalendar': 'Integrazione Google Calendar',
  'pricing.features.unlimitedMessaging': 'Messaggistica Illimitata',
  'pricing.features.customPrograms': 'Programmi Personalizzati',
  'pricing.features.waitlistManagement': 'Gestione Liste d\'Attesa',
  'pricing.features.advancedPrograms': 'Gestione Programmi Avanzata',
  ...
  'pricing.features.advancedCRM': 'CRM Vendite Avanzato',
  ...
  'pricing.detailedFeatures.basic.clientManagement.name': 'Gestione Clienti (fino a 10)',
  'pricing.detailedFeatures.basic.clientManagement.description': 'Database clienti completo con profili comprensivi (obiettivi, limitazioni mediche, preferenze), storico sessioni e tracking progressi per ogni cliente, sistema note e annotazioni private, gestione contatti e informazioni emergenza.',
  'pricing.detailedFeatures.basic.messaging.name': 'Sistema Messaggistica Clienti',
  'pricing.detailedFeatures.basic.messaging.description': 'Chat trainer-cliente in tempo reale, condivisione foto/video per controllo forma, messaggi automatici promemoria sessioni, sistema notifiche push. Limite: 50 messaggi/mese per cliente.',
  'pricing.detailedFeatures.basic.calendar.name': 'Integrazione Calendario',
  'pricing.detailedFeatures.basic.calendar.description': 'Calendario integrato con gestione eventi, sistema rinvio sessioni con notifiche automatiche, gestione disponibilità, funzionalità scheduling base.',
  ...
  'pricing.detailedFeatures.essential.unlimitedSessions.name': 'Sessioni e Clienti Illimitati',
  'pricing.detailedFeatures.essential.unlimitedSessions.description': 'Creazione sessioni individuali e di gruppo, calendario dinamico con disponibilità real-time, sistema prenotazione diretta clienti, sistema cancellazione flessibile, nessun limite sessioni mensili.',
  ...
  'pricing.detailedFeatures.essential.unlimitedMessaging.name': 'Messaggistica Illimitata',
  'pricing.detailedFeatures.essential.unlimitedMessaging.description': 'Nessun limite comunicazione clienti, condivisione multimedia, flussi automatizzati, notifiche prioritarie.',
  ...
  'pricing.detailedFeatures.pro.salesCrm.name': 'CRM Vendite Avanzato',
  'pricing.detailedFeatures.pro.salesCrm.description': 'Pipeline vendite stile Kanban, scoring e qualificazione lead, sequenze vendite automatizzate, analytics conversioni, tracking performance vendite.',
