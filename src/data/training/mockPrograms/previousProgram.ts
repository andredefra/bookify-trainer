...
export const previousProgram: TrainingProgram = {
  ...
  description: "AI-crafted beginner-friendly 4-week program personalized for your fitness level",
  isPaid: false,
  sessions: [
    {
      id: "session-1-prev",
...
export const incompletePreviousProgram: TrainingProgram = {
  ...
  description: "AI-designed intermediate strength building program adapted to your progress",
  isPaid: true,
  price: 65.99,
  sessions: [
    {
