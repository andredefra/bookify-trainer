  ...
  return (
    <>
      <Helmet>
        ...
        <title>Trainer Dashboard — Essential</title>
        <meta name="format-detection" content="telephone=no,date=no,address=no,email=no,url=no" />
      </Helmet>
      <div className="max-w-full overflow-x-hidden" data-lpignore="true">
        <DashboardContainer customName="Trainer (Essential)" plan="essential" />
      </div>
    </>
  );
};

export default DashboardEssential;
